/* eslint-disable */
// Generated by Wrangler by running `wrangler types apps/server/src/worker-configuration.d.ts --config apps/server/wrangler.toml` (hash: 8c2751a83999cad858107e3cbd1b26c6)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		NWS_USER_AGENT: "(WindAppForGreg, weather.rmcd.cc)";
	}
}
